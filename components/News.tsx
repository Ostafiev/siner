      ...
      <div className="container">
        ...
        <div className={`${s.row} reveal`}>
          ...
          <article className={`${s.item} ${s.featured}`}>
            <Link href={featured.href} className={s.card}>
            ...
            <Link href={featured.href} className={s.link}>
              подробнее
            </Link>
          </article>
          ...
          {rest.map((n) => (
            <article key={n.id} className={s.item}>
              <Link href={n.href} className={s.card}>
              ...
              <Link href={n.href} className={s.link}>
                подробнее
              </Link>
            </article>
          ))}
